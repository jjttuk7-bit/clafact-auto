...
def test_adapter_accepts_article_date_context_without_changing_provider_payload() -> None:
    adapter = StructuredOutputAdapter(lambda sentence: {"claim_id":"x","source_sentence":sentence,"indicator":"고용률","value":70,"unit":"%","time":"2024","parse_status":"AUTO_OK"})
    assert adapter.extract("문장", article_published_at=date(2025, 4, 5)).indicator == "고용률"
